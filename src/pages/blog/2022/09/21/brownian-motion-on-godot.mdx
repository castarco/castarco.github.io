...
with the physics engine (stuff such as mass, linear velocity, momentum) because
it seems to be a bit slower than keeping track of the velocity by myself, and I
don't need that much realism for those particles.
